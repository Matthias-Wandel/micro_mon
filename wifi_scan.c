...
// Figuring out how to build it, using USB instead of UART communications
        ...
        if (absolute_time_diff_us(get_absolute_time(), scan_test) < 0) {
            ...
            if (!scan_in_progress) {
                ...
                if (err == 0) {
                    ...
                    scan_test = make_timeout_time_ms(5000); // wait 5s and scan again
                }
